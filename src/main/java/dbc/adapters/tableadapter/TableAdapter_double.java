...
public class TableAdapter_double extends AbstractTableAdapter
{
    double[][] data;
    
    public TableAdapter_double()
    {
        this(null, null);
    }
    
    public TableAdapter_double(TableView tableView, double[][] data)
    {
        this(tableView, data, null);
    }
    
    public TableAdapter_double(TableView tableView, double[][] data, Object[] columnNames)
    {
