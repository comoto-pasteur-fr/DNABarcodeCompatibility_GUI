...
public class TableAdapter_int extends AbstractTableAdapter
{
    int[][] data;
    
    public TableAdapter_int()
    {
        this(null, null);
    }
    
    public TableAdapter_int(TableView tableView, int[][] data)
    {
        this(tableView, data, null);
    }
    
    public TableAdapter_int(TableView tableView, int[][] data, Object[] columnNames)
    {
