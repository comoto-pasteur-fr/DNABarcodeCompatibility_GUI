...
public class DefaultTableCellRender<S, T> extends AbstractTableCellRender<S, T>
{
    ...
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(DefaultTableCellRender.class);
    CheckBox checkBox;
                ...
                try
                {
                    javax.swing.SwingUtilities.invokeAndWait(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            {
                                e.toString();
                                LOGGER.debug("Program continues normally but image was not rendered...");
                            }
                        }
                    });
                }
