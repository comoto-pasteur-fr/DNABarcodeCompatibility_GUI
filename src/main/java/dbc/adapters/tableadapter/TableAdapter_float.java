...
package dbc.adapters.tableadapter;
...
public class TableAdapter_float extends AbstractTableAdapter
{
    float[][] data;
    
    public TableAdapter_float()
    {
        this(null, null);
    }
    
    public TableAdapter_float(TableView tableView, float[][] data)
    {
        this(tableView, data, null);
    }
    
    public TableAdapter_float(TableView tableView, float[][] data, Object[] columnNames)
    {
    ...
    {
        data[rowIndex][columnIndex] = (Float) value;
    }
