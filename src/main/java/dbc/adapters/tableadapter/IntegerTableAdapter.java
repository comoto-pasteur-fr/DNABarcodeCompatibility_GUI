...
public class IntegerTableAdapter extends AbstractTableAdapter
{
    Integer[][] data;
    
    public IntegerTableAdapter()
    {
        this(null, null);
    }
    
    public IntegerTableAdapter(TableView tableView, Integer[][] data)
    {
        this(tableView, data, null);
    }
    
    public IntegerTableAdapter(TableView tableView, Integer[][] data, Object[] columnNames)
    {
